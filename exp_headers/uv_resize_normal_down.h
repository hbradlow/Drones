...
#ifndef UV_RESIZE_NORMAL_DOWN_H
#define UV_RESIZE_NORMAL_DOWN_H

#include <uv_errors.h>
#include <uv_types.h>

/** Downscales images. Uses nearest neighbour method for resize.\n\n
  ...
  */
uv_error uv_resize_normal_down(uv_handle sdk_handle, uv_image *src_img, uv_image *dst_img, int w2, int h2);

#endif /* UV_RESIZE_NORMAL_DOWN_H */
