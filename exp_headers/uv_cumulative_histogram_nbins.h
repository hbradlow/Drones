...
#ifndef UV_CUMULATIVE_HISTOGRAM_NBINS_H
#define UV_CUMULATIVE_HISTOGRAM_NBINS_H

#include <uv_errors.h>
#include <uv_types.h>

/** Performs N-bin Cumulative histogram on an image.This API returns cumulative histogram of N bin.\n\n
  * Limitations and things to know \n
  *
  *   - Returns cumulative histogram of N bin.
  ...
  * @param nbin			: Input param. Number of bins.
  *
  * @return #UV_E_SUCCESS if successful
  */

uv_error uv_cumulative_histogram_nbins(uv_handle sdk_handle, uv_image *src_img,
                                            unsigned long *hist,
                                            char *bins, int nbins);


#endif /* UV_CUMULATIVE_HISTOGRAM_NBINS_H */
