...
#ifndef UV_CUMULATIVE_HISTOGRAM_16BINS_H
#define UV_CUMULATIVE_HISTOGRAM_16BINS_H

#include <uv_errors.h>
#include <uv_types.h>

/** Performs 16-bin Cumulative histogram on an image.\n\n
  * Limitations and things to know \n
  *
  *   - Width of the image should be a multiple of 8
  *   - Returns cumulative histogram of 16 bins.
...
uv_error uv_cumulative_histogram_16bins(uv_handle sdk_handle, uv_image *src_img,
                                            unsigned long *hist,
                                            unsigned char *bins);


#endif /* UV_CUMULATIVE_HISTOGRAM_16BINS_H */
