...
#ifndef UV_HYSTERESIS_THRESHOLD_H
#define UV_HYSTERESIS_THRESHOLD_H

#include <uv_errors.h>
#include <uv_types.h>

/** Performs  hysteresis thresholding on an edge image\n\n
  ...
  */
uv_error uv_hysteresis_threshold(uv_handle sdk_handle, uv_image *src_img, uv_image *dst_img, int high, int low);


#endif /* UV_HYSTERESIS_THRESHOLD_H */
