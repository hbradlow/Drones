...
#ifndef UV_CONVOLUTION_8U_H
#define UV_CONVOLUTION_8U_H
...
uv_error uv_convolution_8u(uv_handle sdk_handle, uv_image *src_img, uv_image *dst_img, char *kernel,
                             int kernel_height, int kernel_width, int kernel_shift);


#endif /* UV_CONVOLUTION_8U */
