...
#ifndef UV_ABSDIFF_IMAGE_REF_H
#define UV_ABSDIFF_IMAGE_REF_H
...
uv_error uv_absdiff_image_ref(uv_handle handle, uv_image *src1_img, uv_image *src2_img, uv_image *dst_img);


#endif /* UV_ABSDIFF_IMAGE_REF_H */
