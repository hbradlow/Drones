...
#ifndef UV_CONVOLUTION_8U_1x5_REF_H
#define UV_CONVOLUTION_8U_1x5_REF_H
...
uv_error uv_convolution_8u_1x5_ref(uv_handle sdk_handle, uv_image *src_img, uv_image *dst_img, char *kernel, int kernel_shift);


#endif /* UV_CONVOLUTION_8U_1x5_REF_H */
