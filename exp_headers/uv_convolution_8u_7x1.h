...
#ifndef UV_CONVOLUTION_8U_7x1_H
#define UV_CONVOLUTION_8U_7x1_H
...
uv_error uv_convolution_8u_7x1(uv_handle sdk_handle, uv_image * src_img, uv_image * dst_img, char * kernel, int kernel_shift);
