...
#ifndef UV_ABSDIFF_IMAGE_H
#define UV_ABSDIFF_IMAGE_H
...
/** Performs difference on two images of type 8bit unsigned\n\n
  ...
  *   - Width of the images should be a multiple of 16
  *
...
uv_error uv_absdiff_image(uv_handle handle, uv_image *src1_img, uv_image *src2_img, uv_image *dst_img);


#endif /* UV_ABSDIFF_IMAGE_H */
