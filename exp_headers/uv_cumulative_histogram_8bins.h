...
#ifndef UV_CUMULATIVE_HISTOGRAM_8BINS_H
#define UV_CUMULATIVE_HISTOGRAM_8BINS_H

#include <uv_errors.h>
#include <uv_types.h>

/** Performs 8-bin Cumulative histogram on an image.\n\n
  * Limitations and things to know \n
  *
  *   - Width of the image should be a multiple of 8
  *   - Returns cumulative histogram of 8 bins.
  ...
  *   - Difference of each histogram bin(hist[n-1]) with its neighbouring bin(hist[n]) will give the number of pixels lying between the 2 bins, bin[n-1] and bin[n].
  *
...
uv_error uv_cumulative_histogram_8bins(uv_handle sdk_handle, uv_image *src_img,
                                            unsigned long *hist,
                                            unsigned char *bins);


#endif /* UV_CUMULATIVE_HISTOGRAM_8BINS_H */
