...
#ifndef UV_ROTATE90_H
#define UV_ROTATE90_H
...
/** Rotates an image by 90 degrees\n\n
  ...
  *   - Height of the image should be a multiple of 8
  *
...
uv_error uv_rotate90(uv_handle sdk_handle, uv_image *src_img, uv_image *dst_img);
